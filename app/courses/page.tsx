    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex gap-2">
          ...
          {/* New Course Button (For Instructors) */}
      ...
      {courses.length === 0 ? (
        <div className="rounded-xl border border-dashed border-zinc-200 py-16 text-center dark:border-zinc-800">
          ...
          <p className="mt-2 text-sm text-zinc-400">No courses found matching your search.</p>
        </div>
      ) : (
              ...
              <div className="mt-6 flex items-center justify-between border-t border-zinc-100 pt-4 dark:border-zinc-800">
                ...
                <div className="flex items-center gap-3 text-zinc-400">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-xs font-medium">{course._count.assignments}</span>
                  </div>
                  <div className="flex items-center gap-1">
